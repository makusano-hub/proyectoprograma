...
void dibujarMapa(ConfigMap *configuracion,ALLEGRO_BITMAP *terreno, ALLEGRO_BITMAP *pasto, ALLEGRO_BITMAP *camino, ALLEGRO_BITMAP *agua, ALLEGRO_BITMAP *oro, ALLEGRO_BITMAP *arbol, ALLEGRO_BITMAP *sheetPortal,ALLEGRO_BITMAP *casa,ALLEGRO_BITMAP *aldea,ALLEGRO_BITMAP *castelo,int framePortal);
